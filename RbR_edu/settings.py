"""
Django settings for RbR_edu project.
...
SECRET_KEY = '7+$!qknh^83y5ij$%+=o!*nmc(ce7s5g3!mub2+e^dt(2z4=3%'
...
# EMAIL_USE_SSL = True
# EMAIL_PORT = 456
# EMAIL_HOST_USER = 'dsws975@gmail.com'
# EMAIL_HOST_PASSWORD = ''
...
WSGI_APPLICATION = 'RbR_edu.wsgi.application'
